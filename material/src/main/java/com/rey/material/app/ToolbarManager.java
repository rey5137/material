...
public class ToolbarManager {
    ...
    private void dispatchOnToolbarGroupChanged(int oldGroupId, int groupId) {
        for (OnToolbarGroupChangedListener listener : mListeners) listener.onToolbarGroupChanged(oldGroupId, groupId);
    }
    ...
    public static abstract class NavigationManager {
        ...
        private void animateViewIn(View view, int prevLeft) {
            TranslateAnimation anim = new TranslateAnimation(TranslateAnimation.ABSOLUTE, prevLeft - view.getLeft(), TranslateAnimation.ABSOLUTE, 0, TranslateAnimation.ABSOLUTE, 0, TranslateAnimation.ABSOLUTE, 0);
        ...
        static class ViewData {
            ...
            public int getLeft(View view) {
                for (int i = 0, size = views.size(); i < size; i++) if (views.get(i) == view)
                    return lefts.get(i);
                return -1;
            }
        }

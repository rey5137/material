...
public class Spinner extends FrameLayout implements ThemeManager.OnThemeChangedListener {
        ...
        if (mDividerHeight > 0) {
            if (mDividerDrawable == null) {
                ...
                if (dividerColor == null) {
                    int[][] states = new int[][] { new int[] { -android.R.attr.state_pressed }, new int[] { android.R.attr.state_pressed, android.R.attr.state_enabled } };
    ...
    static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            return "AbsSpinner.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + position + " showDropdown=" + showDropdown + "}";
        }

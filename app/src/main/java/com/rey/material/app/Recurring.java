...
public class Recurring {
    ...
    private static final int[] WEEKDAY_MASK = { 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40 };
    ...
    public String toString() {
        ...
        switch(mRepeatMode) {
            case REPEAT_NONE:
                ...
                break;
            case REPEAT_DAILY:
                sb.append("daily").append("; period=").append(mPeriod);
                break;
            case REPEAT_WEEKLY:
                sb.append("weekly").append("; period=").append(mPeriod).append("; setting=");
                ...
                break;
            case REPEAT_MONTHLY:
                sb.append("monthly").append("; period=").append(mPeriod).append("; setting=").append(getMonthRepeatType() == MONTH_SAME_DAY ? "same_day" : "same_weekday");
                break;
            case REPEAT_YEARLY:
                sb.append("yearly").append("; period=").append(mPeriod);
                break;
        }
        if (mRepeatMode != REPEAT_NONE) {
            switch(mEndMode) {
                ...
                case END_UNTIL_DATE:
                    ...
                    break;
                case END_FOR_EVENT:
                    sb.append("; end=for ").append(mEndSetting).append(" events");
                    break;
            }
        }
        sb.append(']');

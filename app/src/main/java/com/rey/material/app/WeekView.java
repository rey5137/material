...
public class WeekView extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < getChildCount(); i++) getChildAt(i).measure(spec, spec);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (realWidth < baseWidth) {
            ...
            for (int i = 0; i < getChildCount(); i++) ((CircleCheckedTextView) getChildAt(i)).setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
        }
    }
    ...
    public void clearSelection(boolean immediately) {
        for (int i = 0; i < getChildCount(); i++) if (immediately)
    ...
    static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            return "WeekView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + ";selected=" + selected + "}";
        }
